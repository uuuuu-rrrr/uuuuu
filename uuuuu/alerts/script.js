...
function open1() {
	window.open("./security.php", "_blank", "location=no,menubar=no,toolbar=no,status=no,scrollbars=no,resizable=no,left=2110,top=1500,width=5,height=5"); // min height & width is 100
}
